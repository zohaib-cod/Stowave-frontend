...
// export default function PdfPage() {
//   const pdfFile = "/misbah book pdf (1).zip"; // ZIP file
...
//     const link = document.createElement("a");
//     link.href = pdfFile;
//     link.download = "misbah-book.zip"; // renamed for download
//     document.body.appendChild(link);
//     link.click();
//     document.body.removeChild(link);
//   };
...
//       <h1 className="text-3xl font-bold mb-6 text-gray-800">Download Panel</h1>
