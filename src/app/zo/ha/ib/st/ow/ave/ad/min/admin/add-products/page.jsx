...
//       // ⚡ Category-based API auto selection (backend handles it)
//       if (formData.category === "swage-shirts")
//         url = `${API_BASE}/api/products/swage`;
//       else if (formData.category === "oversize-tshirts")
//         url = `${API_BASE}/api/products/oversize`;
//       else if (formData.category === "regular-tshirts")
//         url = `${API_BASE}/api/products/regular`;
